...
```
php composer.phar require "denobraz/yii2-image-manager" "*" 
```
or add

```json
"denobraz/yii2-image-manager" : "*"
```
...
```
yii migrate --migrationPath=@denobraz/imagemanager/migrations
```
...
'components' => [
    'imagemanager' => [
		'class' => 'denobraz\imagemanager\components\ImageManagerGetPath',
...
'modules' => [
	'imagemanager' => [
		'class' => 'denobraz\imagemanager\Module',
		//set accces rules ()
		'canUploadImage' => true,
...
```php
echo $form->field($model, 'ImageManager_id_avatar')->widget(\denobraz\imagemanager\components\ImageManagerInputWidget::className(), [
